...
ann_file = '/medical-data/zsxm/运动热量估计/eev_resized/clips/per_hour_20s_bin.pkl'
...
# optimizer
optimizer = dict(type='RMSprop', lr=0.01, momentum=0.9, weight_decay=0.0003) #lr 4video1gpu 0.1/16
...
log_level = 'INFO'
work_dir = './work_dirs_ordinal/posec3d/c3d_joint'
auto_resume = False
