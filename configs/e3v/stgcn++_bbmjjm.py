...
train_pipeline = [
    ...
    dict(type='GenSkeFeat', dataset='coco', feats=['b', 'bm', 'j', 'jm']),
...
# optimizer
optimizer = dict(type='RMSprop', lr=0.0001, momentum=0.9, weight_decay=0.0003)
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/e3v/stgcn++/bbmjjm'
auto_resume = False
